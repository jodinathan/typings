...
import '/src/d/typescript/main.dart' as _i4;
...
enum UnionEnum558 {
  ...
  const UnionEnum558(this.value);

  final _i2.String value;
}

typedef ImportExportKind = _i3.UnionEnum557;
typedef TableKind = _i2.String;
typedef ValueType = _i3.UnionEnum558;
...
extension Memory$Typings on Memory {
  ...
  _i2.Object get buffer => _i5.getProperty(
        this,
        'buffer',
      );
...
@_i1.staticInterop
class Module {
  factory Module(_i3.BufferSource bytes) => _i5.callConstructor(
        _declaredModule,
        [bytes],
      );
...
@_i1.staticInterop
class Table {
  factory Table(_i3.TableDescriptor descriptor) => _i5.callConstructor(
        _declaredTable,
        [descriptor],
      );
}
...
extension Table$Typings on Table {
  ...
  _i2.Function? get(_i2.num index) => _i5.callMethod(
        this,
        'get',
        [index],
      );
...
extension GlobalDescriptor$Typings on GlobalDescriptor {
  ...
  _i3.ValueType get value => _i3.UnionEnum558.values.byName(_i5.getProperty(
        this,
        'value',
      ));
...
extension ModuleExportDescriptor$Typings on ModuleExportDescriptor {
  _i3.ImportExportKind get kind =>
      _i3.UnionEnum557.values.byName(_i5.getProperty(
        this,
        'kind',
      ));
...
extension TableDescriptor$Typings on TableDescriptor {
  _i3.TableKind get element => _i5.getProperty(
        this,
        'element',
      );
