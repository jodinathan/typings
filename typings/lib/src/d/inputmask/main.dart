...
import '/src/d/typescript/main.dart' as _i5;
...
enum UnionEnum1340 {
  ...
  const UnionEnum1340(this.value);
...
enum UnionEnum1341 {
  ...
  const UnionEnum1341(this.value);
...
enum UnionEnum1342 {
  ...
  const UnionEnum1342(this.value);
...
enum UnionEnum1343 {
  ...
  const UnionEnum1343(this.value);

  final _i2.String value;
}

typedef Range = _i2.Object;
typedef PositionCaretOnClick = _i3.UnionEnum1341;
typedef InputMode = _i3.UnionEnum1342;
typedef Casing = _i3.UnionEnum1343;
...
extension Options$Typings on Options {
  ...
  _i3.PositionCaretOnClick? get positionCaretOnClick => switch (_i4.getProperty(
        ...
        _i2.String name => _i3.UnionEnum1341.values.byName(name),
        _ => null
      };
  ...
  _i3.Casing? get casing => switch (_i4.getProperty(
        ...
        _i2.String name => _i3.UnionEnum1343.values.byName(name),
        _ => null
      };
  ...
  _i3.InputMode? get inputmode => switch (_i4.getProperty(
        ...
        _i2.String name => _i3.UnionEnum1342.values.byName(name),
        _ => null
      };
  ...
  ///
  ///  @default "text"
  _i3.UnionEnum1340? get inputType => switch (_i4.getProperty(
        this,
        'inputType',
      )) {
        _i2.String name => _i3.UnionEnum1340.values.byName(name),
        _ => null
      };
  set inputType(_i3.UnionEnum1340? value) {
    _i4.setProperty(
      this,
      'inputType',
