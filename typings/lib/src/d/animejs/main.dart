...
import '/src/d/typescript/main.dart' as _i3;
...
enum UnionEnum1077 {
  ...
  const UnionEnum1077(this.value);
...
enum UnionEnum1078 {
  ...
  const UnionEnum1078(this.value);
...
enum UnionEnum1079 {
  ...
  const UnionEnum1079(this.value);
...
enum UnionEnum1080 {
  ...
  const UnionEnum1080(this.value);
...
typedef EasingOptions = _i4.UnionEnum1079;
typedef DirectionOptions = _i4.UnionEnum1080;
...
extension AnimeAnimParams$Typings on AnimeAnimParams {
  ...
  _i3.ReadonlyArray<_i4.AnimeAnimParams>? get keyframes => _i6.getProperty(
        this,
        'keyframes',
      );
  set keyframes(_i3.ReadonlyArray<_i4.AnimeAnimParams>? value) {
    _i6.setProperty(
      this,
      'keyframes',
      value ?? _i5.undefined,
...
class AnimeParams implements _i4.AnimeInstanceParams, _i4.AnimeAnimParams {
  ...
  factory AnimeParams({
    ...
    _i2.dynamic elasticity,
    _i2.dynamic round,
    _i3.ReadonlyArray<_i4.AnimeAnimParams>? keyframes,
    _i2.dynamic easing,
  }) =>
      AnimeParams._(
        loop: loop ?? _i5.undefined,
...
class Animation {
  ...
  factory Animation({
    ...
    required _i3.ReadonlyArray<_i2.Object> tweens,
...
extension Animation$Typings on Animation {
  ...
  _i3.ReadonlyArray<_i2.Object> get tweens => _i6.getProperty(
        this,
        'tweens',
      );
  set tweens(_i3.ReadonlyArray<_i2.Object> value) {
    _i6.setProperty(
      this,
      'tweens',
      value,
...
extension AnimeInstance$Typings on AnimeInstance {
  ...
  _i2.Future<_i2.Future<void>> get finished =>
      _i6.promiseToFuture(_i6.getProperty(
        this,
        'finished',
      ));
  ...
  _i3.ReadonlyArray<_i4.Animatable> get animatables => _i6.getProperty(
        this,
        'animatables',
      );
  set animatables(_i3.ReadonlyArray<_i4.Animatable> value) {
    _i6.setProperty(
      this,
      'animatables',
      value,
  ...
  _i3.ReadonlyArray<_i4.Animation> get animations => _i6.getProperty(
        this,
        'animations',
      );
  set animations(_i3.ReadonlyArray<_i4.Animation> value) {
    _i6.setProperty(
      this,
      'animations',
      value,
...
class StaggerOptions {
  ...
  factory StaggerOptions({
    _i2.dynamic start,
    _i4.UnionEnum1077? direction,
    _i2.dynamic easing,
    _i3.ReadonlyArray<_i2.num>? grid,
    _i4.UnionEnum1078? axis,
    _i2.dynamic from,
  }) =>
      StaggerOptions._(
...
extension StaggerOptions$Typings on StaggerOptions {
  ...
  _i4.UnionEnum1077? get direction => switch (_i6.getProperty(
        this,
        'direction',
      )) {
        _i2.String name => _i4.UnionEnum1077.values.byName(name),
        _ => null
      };
  set direction(_i4.UnionEnum1077? value) {
    _i6.setProperty(
      this,
      'direction',
  ...
  _i3.ReadonlyArray<_i2.num>? get grid => _i6.getProperty(
        this,
        'grid',
      );
  set grid(_i3.ReadonlyArray<_i2.num>? value) {
    _i6.setProperty(
      this,
      'grid',
      value ?? _i5.undefined,
  ...
  _i4.UnionEnum1078? get axis => switch (_i6.getProperty(
        this,
        'axis',
      )) {
        _i2.String name => _i4.UnionEnum1078.values.byName(name),
        _ => null
      };
  set axis(_i4.UnionEnum1078? value) {
    _i6.setProperty(
      this,
      'axis',
      value?.name ?? _i5.undefined,
