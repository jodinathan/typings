...
extension AsyncGenerator$Typings<T, TReturn, TNext>
  ...
  _i2.Future<_i2.Future<_i4.IteratorResult<T, TReturn>>> next(
  ...
  _i2.Future<_i2.Future<_i4.IteratorResult<T, TReturn>>> return$(
          _i2.Object value) =>
      _i5.promiseToFuture(_i5.callMethod(
        this,
        'return',
  ...
  _i2.Future<_i2.Future<_i4.IteratorResult<T, TReturn>>> throw$(
          _i2.dynamic e) =>
      _i5.promiseToFuture(_i5.callMethod(
        this,
        'throw',
...
_i7.$ModuleIntl get intl => _i5.getProperty(
      _self,
      'Intl',
    );
_i8.$ModuleReflect get reflect => _i5.getProperty(
      _self,
      'Reflect',
    );
_i9.$ModuleCss get css => _i5.getProperty(
      _self,
      'CSS',
    );
_i10.$ModuleWebAssembly get webAssembly => _i5.getProperty(
      _self,
      'WebAssembly',
    );
