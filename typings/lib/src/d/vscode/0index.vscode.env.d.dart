...
extension ClipboardAccessor$Typings on _ClipboardAccessor {
  ...
  _i2.Future<_i2.Future<_i3.ClipboardItems>> read() =>
  ...
  _i2.Future<_i2.Future<_i2.String>> readText() =>
      _i4.promiseToFuture(_i4.callMethod(
        _i5.target3400,
        'readText',
        [],
  ...
  _i2.Future<_i2.Future<void>> write(_i3.ClipboardItems data) =>
      _i4.promiseToFuture(_i4.callMethod(
        _i5.target3400,
        'write',
        [data],
  ...
  _i2.Future<_i2.Future<void>> writeText(_i2.String data) =>
      _i4.promiseToFuture(_i4.callMethod(
        _i5.target3400,
        'writeText',
        [data],
...
extension $ModuleEnv$Typings on $ModuleEnv {
  ...
  _i3.Clipboard get clipboard => _i4.getProperty(
        this,
        'clipboard',
      );
  ...
  _i3.Event get onDidChangeTelemetryEnabled => _i4.getProperty(
        this,
  ...
  _i8.UIKind get uiKind => _i8.UIKind.values.byName(_i4.getProperty(
        this,
        'uiKind',
      ));

  /// The current log level of the editor.
  _i8.LogLevel get logLevel => _i8.LogLevel.values.byName(_i4.getProperty(
        this,
        'logLevel',
      ));

  /// An {@link Event} which fires when the log level of the editor changes.
  _i3.Event get onDidChangeLogLevel => _i4.getProperty(
        this,
        'onDidChangeLogLevel',
      );
